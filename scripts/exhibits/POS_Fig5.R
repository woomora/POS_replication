...
scpi_estimates_file <- "results/Fig5/scpi_estimates_controls.csv"
scpi_inference_file <- "results/Fig5/scpi_inference_controls.csv"
scpi_weights_file <- "results/Fig5/scpi_weights_controls.csv"
...
ggsave("results/Fig5/Fig5a.png", dpi = 300, width = 7.4, height = 4.8)
...
scpi_estimates |> 
  ...
  geom_vline(xintercept = 0) +
  scale_y_continuous(breaks = seq(-0.1, 0.035, 0.01)) +
...
ggsave("results/Fig5/Fig5b.png", dpi = 300, width = 7.4, height = 4.8)
